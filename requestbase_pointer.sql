...
CREATE TABLE `pointer` (
  `first_char` char(45) NOT NULL,
  `base_number` int DEFAULT NULL,
  PRIMARY KEY (`first_char`)
...
INSERT INTO `pointer` VALUES ('1',1),('a',4),('а',14),('б',32),('в',34),('г',36),('и',37),('к',38),('л',40),('м',42),('р',46),('т',57),('у',61),('ч',63);
